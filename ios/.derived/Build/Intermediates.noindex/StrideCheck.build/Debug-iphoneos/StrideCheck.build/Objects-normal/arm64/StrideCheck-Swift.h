...
#ifndef STRIDECHECK_SWIFT_H
#define STRIDECHECK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StrideCheck",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11StrideCheck15LocationService")
...
@class CLLocation;
@interface LocationService (SWIFT_EXTENSION(StrideCheck)) <CLLocationManagerDelegate>
