...
- **Mark**: near-black `#0C0C0F` background, **electric amber `#F5B700`** diamond / rhombus outline with a single horizontal pace-line through the center — reads as a race checkpoint or timing gate at small sizes.
...
| Area                 | Files                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| App                  | `StrideCheckApp.swift`, `ContentView.swift` (tab shell + reload wiring), `ConditionsTabView.swift`, `RouteAnd511View.swift`, `TopEdgeFrostFade.swift`, `ConditionsReloadCenter.swift`, `WearableDataSourcesView.swift` (run-index data sources), `MapDataSourcesView.swift` (Strava map overlay + OAuth client fields), `RouteTrafficMapView.swift` (MapKit traffic + overlays), `LaunchScreen.storyboard` (full-screen launch; avoids letterboxing on modern iPhones)                                                                                                                                                                                                                                       |
| State                | `ViewModels/ConditionsViewModel.swift` (load **sequencing**, benign **cancellation** handling); `ConditionsReloadCenter` for wearable-driven refetch                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Location             | `Services/LocationService.swift`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Conditions & scoring | `Services/ConditionsService.swift`, `Services/ConditionsFetching.swift`, `Services/APIModels.swift`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
- **Auto-refresh after wearables:** when Whoop or Garmin **connects** or **disconnects**, Oura token is **saved** or **removed**, or **Use for run index** toggles change, `ConditionsReloadCenter` requests a refetch and **ContentView** reloads conditions if a **coordinate** or valid **zip** is available—no need to pull-to-refresh for run metrics alone.
